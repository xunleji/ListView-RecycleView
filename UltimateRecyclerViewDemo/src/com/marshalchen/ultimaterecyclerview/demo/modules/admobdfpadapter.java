 ...
 */
public class admobdfpadapter extends AdmobAdapter<LinearLayout, String, admobdfpadapter.ViewHolder> {
    public admobdfpadapter(LinearLayout v, int e, List<String> f) {
        super(v, false, e, f);
    }

    public admobdfpadapter(LinearLayout v, int e, List<String> f, AdviewListener listener) {
