...
public class SwipeLayout extends FrameLayout {
	...
	protected void onLayout(boolean changed, int l, int t, int r, int b) {
		...
		if (mOnLayoutListeners != null)
			for (int i = 0; i < mOnLayoutListeners.size(); i++) {
				mOnLayoutListeners.get(i).onLayouts(this);
			}
	}
	 ...
	 * {@link com.marshalchen.ultimaterecyclerview.swipe.SwipeLayout.ShowMode}
	 * .PullOut and
	 * {@link com.marshalchen.ultimaterecyclerview.swipe.SwipeLayout.ShowMode}
	 * .LayDown.
	 * 
	 ...
	 * get the open status.
	 * 
	 * @return {@link com.marshalchen.ultimaterecyclerview.swipe.SwipeLayout.Status}
